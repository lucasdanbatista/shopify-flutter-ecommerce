...
class _HomeProvider implements HomeProvider {
  _HomeProvider(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  Future<List<HomeBannerDTO>> getBanners() async {
    ...
    var value = _result.data!
        .map((dynamic i) => HomeBannerDTO.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
  ...
  Future<List<HomeSectionDTO>> getSections() async {
    ...
    var value = _result.data!
        .map((dynamic i) => HomeSectionDTO.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
